...
struct fmt::formatter<RE::hkpSurfaceInfo::SupportedState> : fmt::formatter<std::string_view>
{
    auto format(RE::hkpSurfaceInfo::SupportedState a_state, fmt::format_context& a_ctx) const
    {
        ...
        switch (a_state) {
        case RE::hkpSurfaceInfo::SupportedState::kUnsupported: name = "No"; break;
        case RE::hkpSurfaceInfo::SupportedState::kSliding: name = "Slide"; break;
        case RE::hkpSurfaceInfo::SupportedState::kSupported: name = "Yes"; break;
        default: name = "Udf"; break;
        }

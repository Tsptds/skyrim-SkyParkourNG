...
namespace ScaleUtility {
    [[nodiscard]] RE::NiAVObject *FindBoneNode(const RE::Actor *a_actorptr, const std::string_view a_nodeName, bool a_isFirstPerson);
    ...
    [[nodiscard]] float GetScale(RE::Actor *a_actor);
}  // namespace ScaleUtility
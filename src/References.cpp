...
namespace HardCodedVariables {
    ...
    const float medLedgeLimit  = 110.0f;
    ...
    const float medLedgeElevation = 155.0f;
...
void RuntimeMethods::SwapLegs() {
    ...
    RE::PlayerCharacter::GetSingleton()->SetGraphVariableBool("SkyParkourStepLeg",
                                                              RuntimeVariables::shouldUseRightStep);
